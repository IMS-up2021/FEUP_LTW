...
VALUES
('John Smith', 'johnsmith', 'password123', 'john.smith@example.com', 'client'),
('Jane Doe', 'janedoe', 'password123', 'jane.doe@example.com', 'agent'),
('Admin User', 'admin', 'password123', 'admin@example.com', 'admin');
